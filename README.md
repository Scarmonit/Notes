...
- Attach images by pasting, dropping a file anywhere on the window, or `Ctrl+Shift+I`; they render as pictures inline in the editor and live in `%APPDATA%\Notes\attachments`
