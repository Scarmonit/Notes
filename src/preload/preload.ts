...
const api: NotesApi = {
  ...
  openAttachment: (name) => ipcRenderer.invoke(IPC.openAttachment, name),
  assetSizes: (names) => ipcRenderer.invoke(IPC.assetSizes, names),
  contextAttachment: (name) => ipcRenderer.send(IPC.contextAttachment, name),
